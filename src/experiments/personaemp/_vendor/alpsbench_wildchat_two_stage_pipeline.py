"""Vendored from AlpsBench commit 0fd801c0eac123510013e14aa0d032c8392de9dc.

The prompts and two-stage annotation logic are preserved. The eager API client
is disabled so the PersonaEmp adapter can inject its configured client without
reading or duplicating credentials.
"""
